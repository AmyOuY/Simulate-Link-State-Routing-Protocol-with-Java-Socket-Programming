                ...
                if(message.sospfType == 0){
                    ...
                    if (message.sospfType == 0) {
                    	...
                    	for (LSA lsa : lsaArray) {
                                 //if client hasn't connected to this server before
                                 //add this lsa to server's lsd
                    ...
                    }else if (message.sospfType == 2) {//if it is a Disconnect message, delete neighbor form lsd and ports, then LSAPdate message
                    	//delete neighbor from lsd
